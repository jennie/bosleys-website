<template>
  <div class="mb-6 p-3 border-2 border-white bg-black">
    <h3 class="text-lg font-bold mb-2 text-center text-white">*** BOSLEY'S PAWPULARITY ***</h3>
    
    <!-- Retro divider -->
    <div class="text-center text-white text-xs mb-3">~~~~~~~~~~~~~~~~~~~~~~~~</div>
    ...
    <div class="grid grid-cols-3 gap-2">
      ...
      <!-- Chin Scritches -->
      <div class="text-center p-2 border border-white">
        <div class="text-xl font-bold text-white">{{ stats.chinScritches }}</div>
        <div class="text-2xl">👆</div>
